...
public class FormularioClientes extends javax.swing.JFrame {
    ...
    public JTable getTlbClientes() {
        return tlbClientes;
    }

    public void setTlbClientes(JTable tlbClientes) {
        this.tlbClientes = tlbClientes;
    }
    ...
    public void ExportarRegistros() {
        ...
        String sql = "SELECT * INTO OUTFILE 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/Clientes.csv' FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' FROM Articulo";
    ...
    private void initComponents() {
        ...
        jLabel104.setText("Identificación:");
